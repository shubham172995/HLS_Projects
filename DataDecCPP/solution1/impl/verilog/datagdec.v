...
reg    ap_block_state3;
wire   [0:0] tmp_tlast_fu_140_p2;
reg   [0:0] tmp_tlast_reg_168;
wire   [0:0] exitcond_fu_128_p2;
wire   [127:0] dat_data_V_fu_151_p3;
reg   [3:0] i2_reg_117;
reg    ap_block_state2_io;
wire   [63:0] tmp_3_fu_146_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((din_V_tlast_1_vld_out == 1'b1) & (din_V_tlast_1_ack_out == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((din_V_tlast_1_vld_in == 1'b1) & (din_V_tlast_1_ack_in == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((din_V_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((din_V_tlast_1_load_A == 1'b1)) begin
        din_V_tlast_1_payload_A <= tmp_tlast_reg_168;
    end
end

always @ (posedge ap_clk) begin
    if ((din_V_tlast_1_load_B == 1'b1)) begin
        din_V_tlast_1_payload_B <= tmp_tlast_reg_168;
    end
end

always @ (posedge ap_clk) begin
    if ((~((dout_words_V_tlast_1_ack_in == 1'b0) | (din_V_data_V_1_ack_in == 1'b0) | (dout_words_V_data_V_1_ack_in == 1'b0) | (din_words_V_tlast_1_ack_in == 1'b0) | (din_words_V_data_V_1_ack_in == 1'b0) | (control_V_1_ack_in == 1'b0) | (din_V_tlast_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
        i_reg_163 <= i_fu_134_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((dout_words_V_tlast_1_ack_in == 1'b0) | (din_V_data_V_1_ack_in == 1'b0) | (dout_words_V_data_V_1_ack_in == 1'b0) | (din_words_V_tlast_1_ack_in == 1'b0) | (din_words_V_data_V_1_ack_in == 1'b0) | (control_V_1_ack_in == 1'b0) | (din_V_tlast_1_ack_in == 1'b0)) & (exitcond_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_tlast_reg_168 <= tmp_tlast_fu_140_p2;
    end
end

always @ (*) begin
    if ((~((dout_words_V_tlast_1_ack_in == 1'b0) | (din_V_data_V_1_ack_in == 1'b0) | (dout_words_V_data_V_1_ack_in == 1'b0) | (din_words_V_tlast_1_ack_in == 1'b0) | (din_words_V_data_V_1_ack_in == 1'b0) | (control_V_1_ack_in == 1'b0) | (din_V_tlast_1_ack_in == 1'b0)) & (exitcond_fu_128_p2 == 1'd1) & (din_V_data_V_1_state[1'd0] == 1'b0) & (dout_words_V_tlast_1_state[1'd0] == 1'b0) & (dout_words_V_data_V_1_state[1'd0] == 1'b0) & (din_words_V_tlast_1_state[1'd0] == 1'b0) & (din_words_V_data_V_1_state[1'd0] == 1'b0) & (control_V_1_state[1'd0] == 1'b0) & (din_V_tlast_1_state[1'd0] == 1'b0) & (1'b1 == ap_CS_fsm_state3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if ((~((dout_words_V_tlast_1_ack_in == 1'b0) | (din_V_data_V_1_ack_in == 1'b0) | (dout_words_V_data_V_1_ack_in == 1'b0) | (din_words_V_tlast_1_ack_in == 1'b0) | (din_words_V_data_V_1_ack_in == 1'b0) | (control_V_1_ack_in == 1'b0) | (din_V_tlast_1_ack_in == 1'b0)) & (exitcond_fu_128_p2 == 1'd1) & (din_V_data_V_1_state[1'd0] == 1'b0) & (dout_words_V_tlast_1_state[1'd0] == 1'b0) & (dout_words_V_data_V_1_state[1'd0] == 1'b0) & (din_words_V_tlast_1_state[1'd0] == 1'b0) & (din_words_V_data_V_1_state[1'd0] == 1'b0) & (control_V_1_state[1'd0] == 1'b0) & (din_V_tlast_1_state[1'd0] == 1'b0) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((dout_words_V_tlast_1_ack_in == 1'b0) | (din_V_data_V_1_ack_in == 1'b0) | (dout_words_V_data_V_1_ack_in == 1'b0) | (din_words_V_tlast_1_ack_in == 1'b0) | (din_words_V_data_V_1_ack_in == 1'b0) | (control_V_1_ack_in == 1'b0) | (din_V_tlast_1_ack_in == 1'b0)) & (exitcond_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    ap_block_state3 = ((dout_words_V_tlast_1_ack_in == 1'b0) | (din_V_data_V_1_ack_in == 1'b0) | (dout_words_V_data_V_1_ack_in == 1'b0) | (din_words_V_tlast_1_ack_in == 1'b0) | (din_words_V_data_V_1_ack_in == 1'b0) | (control_V_1_ack_in == 1'b0) | (din_V_tlast_1_ack_in == 1'b0));
end
...
assign dat_data_V_fu_151_p3 = ((t_q0[0:0] === 1'b1) ? 128'd340282366920938463463374607431768211455 : 128'd0);
...
assign exitcond_fu_128_p2 = ((i2_reg_117 == 4'd8) ? 1'b1 : 1'b0);

assign i_fu_134_p2 = (i2_reg_117 + 4'd1);

assign t_address0 = tmp_3_fu_146_p1;

assign tmp_3_fu_146_p1 = i2_reg_117;

assign tmp_tlast_fu_140_p2 = ((i2_reg_117 > 4'd6) ? 1'b1 : 1'b0);
